{
## the stable nixos branch gets published for the month 05 and 11 every year.
...
#  inputs.nixpkgs.url = "github:NixOS/nixpkgs/nixos-25.11";
  ...
  outputs = { huskyos, self, ... } : huskyos.${builtins.replaceStrings ["\n"] [""] (builtins.readFile ./EDITION)} self;
}
